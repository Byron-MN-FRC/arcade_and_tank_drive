...
public class Robot extends TimedRobot {
    ...
    // WPI_TalonFX _rghtFollower = new WPI_TalonFX(2);
    // WPI_TalonFX _leftFront = new WPI_TalonFX(1);
    // WPI_TalonFX _leftFollower = new WPI_TalonFX(0);    
    
    WPI_TalonFX _rghtFront = new WPI_TalonFX(2);
    ...
    Joystick _joystick = new Joystick(0);   //Right
    Joystick _joystick1 = new Joystick(1);  //Left
    Joystick _joystick2 = new Joystick(2);  //XBox Controller
    ...
    public void teleopPeriodic() {
        ...
        boolean arcadeMode = SmartDashboard.getBoolean("Arcade Mode", true);
        ...
        if(arcadeMode) {
            ...
            double tankLeft =  -1 * _joystick2.getRawAxis(5) - _joystick.getY();
            double tankRight =  -1 * _joystick2.getRawAxis(1) - _joystick1.getY();
            // if ((Math.abs(tankLeft) < 0.05) && (Math.abs(tankRight) < 0.05)){
            //     tankLeft = _joystick.getY();
            //     tankRight = _joystick1.getY();
            // }

            SmartDashboard.putNumber("tankLeft", tankLeft);
            SmartDashboard.putNumber("tankRight", tankRight);

            _diffDrive.tankDrive(tankLeft,tankRight);
        }
    ...
    public void robotInit() {
        ...
        SmartDashboard.putBoolean("Arcade Mode", true);
